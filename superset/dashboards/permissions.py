...
from superset.models.dashboard import Dashboard  # 确保正确导入 Dashboard 模型
...
class DashboardPermissions:
    ...
    @staticmethod
    def has_permission(dashboard_id: int, user, permission_type: str) -> bool:
        """
    ...
    @staticmethod
    def check_permission(dashboard: Dashboard, user, permission_type: str) -> bool:
        """
        检查用户是否有某种类型的权限。
    ...
    @staticmethod
    def get_dashboard_and_check_permission(pk: int, permission_type: str) -> Dashboard | None:
        """
        获取仪表盘并检查用户权限。
    ...
    @staticmethod
    def get_allowed_dashboard_ids(user, permission_type: str) -> list[int]:
        """
